...
class AddFileCompanyScreen extends StatefulWidget {
  const AddFileCompanyScreen({super.key});

  @override
  State<AddFileCompanyScreen> createState() => _AddFileCompanyScreenState();
}

class _AddFileCompanyScreenState extends State<AddFileCompanyScreen> {
